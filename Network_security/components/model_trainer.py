...
from Network_security.utils.common import save_object,load_object
from Network_security.utils.common import load_numpy_array_data,evaluate_models
...
import dagshub
dagshub.init(repo_owner='kraj2003', repo_name='Network_security', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        # to ge best model score from dict
